package com.project.runner;
    ...
    public class TestRunner extends AbstractTestNGCucumberTests {
        ...
        public void runCreatejobopeningPositive() {
            runCucumberFeature("src/test/resources/com/automation-testing/features/CreateJobOpening_positive.feature");
        }
    
    @Test(priority = 1)
        public void runLoginscreenforrecruitersPos() {
            runCucumberFeature("src/test/resources/com/automation-testing/features/LoginScreenForRecruiters_pos.feature");
        }
